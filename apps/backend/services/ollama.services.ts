...
//Réponds toujours en français (sauf si on te demande du SQL), de manière structurée et avec des données chiffrées quand c'est possible. Si tu ne disposes pas d'une information précise, indique-le clairement.`;
