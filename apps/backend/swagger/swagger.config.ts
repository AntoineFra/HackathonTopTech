...
const swaggerDefinition = {
  ...
  info: {
    ...
    version: '1.0.0',
    description: 'API complète pour le projet Hackathon TopTech - Gestion des données géographiques, IA et unités légales',
    contact: {
      name: 'API Support',
  ...
  tags: [
    {
      name: 'Dump',
      description: 'Gestion des imports de données (unités légales, villes)',
    },
    {
      name: 'Users',
    ...
    schemas: {
      ...
      CityGeoData: {
        ...
        properties: {
          ...
          bbox: {
            type: 'string',
            description: 'Bounding box GeoJSON de la ville (stringifié)',
            nullable: true,
          },
        },
      },
      ...
      AIResponse: {
        ...
        properties: {
          answer: {
            ...
            example: 'La population de Nice est de 340 000 habitants environ.',
          },
          model: {
            type: 'string',
      ...
      Settings: {
        ...
        properties: {
          ...
          aiTimeout: {
            type: 'integer',
            description: 'Timeout en millisecondes pour les requêtes IA',
            example: 30000,
          },
        },
      },
      UpdateSettingsInput: {
        ...
        properties: {
          aiTimeout: {
            type: 'integer',
            description: 'Timeout en millisecondes pour les requêtes IA (0-10000000)',
            example: 45000,
            minimum: 0,
            maximum: 10000000,
          },
