 ...
 */
export function setCityColor(
    scene: THREE.Scene,
    cityName: string | null,
    selectedColor: number = 0x81c784,
) {
 ...
 */
export function setHoveredCityColor(
    scene: THREE.Scene,
    hoveredCity: string | null,
    selectedCity: string | null,
    hoverColor: number = 0xffeb3b,
    selectedColor: number = 0x81c784,
) {
    scene.traverse((object) => {
        if (object.userData.type === "city") {
 ...
 */
export function createMountainsBorder(bounds: {
    minX: number;
    maxX: number;
    minZ: number;
    maxZ: number;
