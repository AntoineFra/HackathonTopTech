# 📚 Documentation du Portail des Données du Territoire 06
...
**👉 Idéal pour :** Démarrage rapide, premiers pas
...
**👉 Idéal pour :** Implémenter le service IA
...
**👉 Idéal pour :** Vue d'ensemble visuelle
...
1. **Problème d'installation ?** → [DEMARRAGE_RAPIDE.md](DEMARRAGE_RAPIDE.md) - Section "Problèmes courants"
2. **Erreur d'intégration IA ?** → [AI_INTEGRATION.md](AI_INTEGRATION.md) - Exemples et debug
3. **Question sur l'architecture ?** → [PROJECT_README.md](PROJECT_README.md) - Documentation technique
...
Voir [PROJECT_README.md](PROJECT_README.md) pour plus de détails.

---

**Bonne lecture et bon hackathon ! 🚀**
