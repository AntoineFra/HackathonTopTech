...
export const sampleCategories: IndicatorCategory[] = [
    {
        ...
        name: "Démographie",
        description:
            "Données de population, répartition par âge, statistiques migratoires",
    },
    {
        id: "economy",
        name: "Économie",
        description:
            "Taux d'emploi, PIB, secteurs d'activité, niveaux de revenus",
    },
    {
        id: "tourism",
        name: "Tourisme",
        description:
            "Arrivées touristiques, taux d'occupation hôtelière, revenus touristiques",
    },
    {
        id: "infrastructure",
        name: "Infrastructure",
...
export const sampleIndicators: Indicator[] = [
    ...
    },
    {
        ...
        description:
            "Arrivées touristiques annuelles dans la région Côte d'Azur",
    },
    {
...
export function searchIndicators(keyword: string): Indicator[] {
    ...
    return sampleIndicators.filter(
        (ind) =>
